...
const LAYER_GENERAL_MASK_BIT = 1
const LAYER_PLATFORMS_MASK_BIT = 2
const LAYER_WATER_MASK_BIT = 1 << 2
const LAYER_KILLBOX_MASK_BIT = 1 << 3
const LAYER_PLAYER_BULLETS_MASK_BIT = 1 << 4
